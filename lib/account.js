...
export const isHidden = (actorId) => {
  const hidden = getHidden();
  return hidden.includes(actorId);
}
...
export const writeHidden = (hidden) => {
  return writeJSONDictionary(hiddenFile, hidden);
}

export const getHidden = () => {
  return readJSONDictionary(hiddenFile);
}
